import { ParsedRequest, Theme, FileType, Background } from '../api/_lib/types';
...
const themeOptions: DropdownOption[] = [
    ...
    // ダークテーマはよくわからなかったのでコメントアウトしておきます
...
const App = (_: any, state: AppState, setState: SetState) => {
    ...
    url.searchParams.append('blog_author', blog_author);
            ...
            H('div',
                ...
                H(Field, {
                    ...
                    input: H(Dropdown, {
                        ...
                        value: background,
                        onchange: (val: Background) => setLoadingState({ background: val })
                    })
                }),
                H(Field, {
                    label: 'File Type',
                ...
                H(Field, {
                    ...
                    input: H(TextInput, {
                        ...
                        oninput: (val: string) => {
                            console.log('oninput ' + val);
                            setLoadingState({ blog_author: val, overrideUrl: url });
                        }
                    })
                }),
            )
